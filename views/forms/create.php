...
<div class="container-fluid bg-light mx-md-4 shadow rounded mb-4" id="departments" style="min-height: 85vh">
    <div class="row">
        <div class="col-12">
            <p class="h3 text-center"><?php if (isset($query_params['fid'])) { echo "Edit"; } else { echo "Create"; }?>
                a Form</p>
        </div>
...
let builder = $(document.getElementById('builder')).formBuilder(options).promise.then(builder => {
