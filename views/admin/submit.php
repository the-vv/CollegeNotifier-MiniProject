    ...
    if (isset($user['error'])) {
        ...
        <svg xmlns='http://www.w3.org/2000/svg' style='display: none;'>
            ...
            <div class='row my-4 text-center'>
                ...
                <span><a class='btn btn-light shadow border px-5 py-1' href='admin/signup'>Sign Up/ Login</a></span>
            </div>
        ";
    } elseif (count($user) > 0) {
        if (password_verify($lpassword, $user[0]['admin_password'])) {
            ...
            <svg xmlns='http://www.w3.org/2000/svg' style='display: none;'>
                ...
                <div class='row my-4 text-center'>
                    ...
                    <span><a class='btn btn-light shadow border px-5 py-1' href='admin/login'>Login</a></span>
                </div>
            ";
        }
    } else {
...
if (isset($_POST['update'])) {
    ...
    require_once $_SERVER['DOCUMENT_ROOT'] . '/db/admin.php';
    $user = update_admin($name, $email, $phone, $hashed);
    if (isset($user['error'])) {
        echo "
        <svg xmlns='http://www.w3.org/2000/svg' style='display: none;'>
            <symbol id='exclamation-triangle-fill' fill='currentColor' viewBox='0 0 16 16'>
        ...
        $success_mess = 'Profile updated successfully';
        require $_SERVER['DOCUMENT_ROOT'] . '/utils/show_success.php';
        echo "    
        <div class='row'>
            <div class='col-12 text-center'>
                <span>
                    <a class='btn btn-light shadow border px-5 py-1' href='/my-profile'>Continue</a>
                </span>
            </div>
        </div>
    ";
