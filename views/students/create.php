...
$can_create_map = $user['type'] == 'admin' || $user['type'] == 'faculty';
?>
...
<div class="row p-1 align-items-end">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <?php if ($can_create_map) { ?>
            <p class="p-0 m-0">
                <span>
                    <a href="/students/map<?php if ($room) {
                            echo "-room";
                        } ?>?<?php echo $url_with_query_params ?>" type="button" class="px-3 btn btn-outline-success rounded rounded-pill btn-sm">
                        Add <i class="bi bi-person-plus-fill"></i>
                    </a>
                </span>
                <?php if (!$room) { ?>
                    <span>
                        <button type="button" data-bs-toggle="modal" class="ms-1 btn btn-outline-primary rounded rounded-pill btn-sm" data-bs-target="#modelMultiple">
...
<!-- Modal -->
<?php if (!$room) { ?>
    <div class="modal fade" id="modelSingle" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                    ...
                    <div class="col-12">
                        ...
                        <form class="row gx-1 align-items-end" action="students/submit?<?php echo $submit_url_params ?>" method="POST" id="singleForm">
                            <div class="form-group col-12 col-md-6 text-start">
                                ...
                                <input type="text" class="form-control" name="name" id="sname" required aria-describedby="categoryHelp" placeholder="Enter Name">
                                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                            </div>
                            <div class="form-group col-12 col-md-6 text-start">
                                <label for="exampleInputEmail1">Phone</label>
                                <input type="text" class="form-control" name="phone" id="snumber" aria-describedby="categoryHelp" placeholder="Enter phone">
                                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-target="#modelMultiple" data-bs-toggle="modal" data-bs-dismiss="modal">Create Multiple Students</button>
    ...
    <div class="modal fade" id="modelMultiple" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="students/submit?<?php echo $submit_url_params ?>&multiple=1" method="post" enctype="multipart/form-data" id="fileForm">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-target="#modelSingle" data-bs-toggle="modal" data-bs-dismiss="modal">Create Single Student</button>
