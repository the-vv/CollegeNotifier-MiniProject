...
function encrypt($text)
{
    ...
    $encryption_iv = GlobalConfig::hashing_iv;
    // Store the encryption key
    $encryption_key = GlobalConfig::hashing_key;
...
function decrypt($text)
{
    ...
    $ciphering = "AES-128-CTR";
    $options = 0;
    $decryption_iv = GlobalConfig::hashing_iv;
    // Store the decryption key
    $decryption_key = GlobalConfig::hashing_key;
